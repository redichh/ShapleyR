...
#' @param shap.values A shapley object (generated by shapley function) that contains
...
plot.shapley.singleValue = function(shap.values) {
  ...
  plot = ggplot(points, aes(x = values, y = 0)) +
    ...
    geom_point(aes(x = getShapleyPredictionResponse(shap.values), y = 0.1), colour = "black", size = 3) +
